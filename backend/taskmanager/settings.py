...
SPECTACULAR_SETTINGS = {
    'TITLE': config('API_TITLE', default='Task Manager API'),
    'DESCRIPTION': config('API_DESCRIPTION', default='Una API completa para gestión de tareas construida con Django REST Framework'),
